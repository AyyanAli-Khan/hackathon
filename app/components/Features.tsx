...
//   return (
//    <section className='w-full h-[355px] text-primary pt-[60px] px-[80px]'>

//     <h1 className='text-h3 font-clash text-center font-[300]'>What makes our brand different</h1>

//     <div className='flex items-center px-10 gap-5 justify-around'>
//         {
//             featureCardDetails.map((featureCard, index) => (
//                 <FeaturesCard heading={featureCard.heading} text={featureCard.text} iconPath={featureCard.iconPath} key={index} />
//             )
//             )
//         }
